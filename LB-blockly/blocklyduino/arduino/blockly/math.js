...
Blockly.Arduino['math_multiple2'] = function (block) {
    var arg0     = Blockly.Arduino.valueToCode(block, 'NUM1', Blockly.Arduino.ORDER_MEMBER) || '0';
    var arg1     = Blockly.Arduino.valueToCode(block, 'NUM2', Blockly.Arduino.ORDER_MEMBER) || '0';
    var operator = block.getFieldValue('OP');
    var code     = "";
    switch (operator) {
        case 'MAX':  code = 'max'; break;
        case 'MIN':  code = 'min'; break;
        case 'POW':  code = 'pow'; break;
    }
    code += '(' + arg0 + ', ' + arg1 + ')';
...
Blockly.Arduino['math_constant'] = function (block) {
    ...
    var CONSTANTS = {
        ...
        'HALF_PI': ['HALF_PI', Blockly.Arduino.ORDER_ATOMIC],
        'TWO_PI' : ['TWO_PI',  Blockly.Arduino.ORDER_ATOMIC],
        // 'GOLDEN_RATIO':
...
Blockly.Arduino['math_trig'] = function (block) {
    ...
    var code;
    switch (operator) {
        case 'SIN':  code = 'sin'; break;
        case 'COS':  code = 'cos'; break;
        case 'TAN':  code = 'tan'; break;
    }
...
Blockly.Arduino['math_round'] = function (block) {
    var number = Blockly.Arduino.valueToCode(block, 'NUM', Blockly.Arduino.ORDER_MEMBER) || '0';
    var code = 'round(' + number + ')';
    return [code, Blockly.Arduino.ORDER_MEMBER];
};
...
Blockly.Arduino['math_constrain'] = function (block) {
    var argument0 = Blockly.Arduino.valueToCode(block, 'VALUE', Blockly.Arduino.ORDER_COMMA) || '0';
    var argument1 = Blockly.Arduino.valueToCode(block, 'LOW',   Blockly.Arduino.ORDER_COMMA) || '0';
    var argument2 = Blockly.Arduino.valueToCode(block, 'HIGH',  Blockly.Arduino.ORDER_COMMA) || '0';
...
Blockly.Arduino['math_random_seed'] = function (block) {
    var argument = Blockly.Arduino.valueToCode(block, 'SEED', Blockly.Arduino.ORDER_NONE) || '0';
    var code = 'randomSeed(' + argument + ');\n';
    return code;
};

Blockly.Arduino['math_map_from'] = function (block) {
    var argument0 = Blockly.Arduino.valueToCode(block, 'NUM', Blockly.Arduino.ORDER_NONE) || '0';
    var code = argument0;
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino['math_map_to'] = function (block) {
...
Blockly.Arduino['math_map'] = function (block) {
    var value_number   = Blockly.Arduino.valueToCode(this, 'Number',   Blockly.Arduino.ORDER_NONE);
    var value_fromlow  = Blockly.Arduino.valueToCode(this, 'fromLow',  Blockly.Arduino.ORDER_NONE);
    var value_fromhigh = Blockly.Arduino.valueToCode(this, 'fromHigh', Blockly.Arduino.ORDER_NONE);

    // split into array
    value_fromlow  = value_fromlow.split(',');
    value_fromhigh = value_fromhigh.split(',');
