...
Blockly.Arduino['board_base_map'] = function (block) {
    ...
    var value_tolow    = Blockly.Arduino.valueToCode(this, 'toLow',  Blockly.Arduino.ORDER_NONE);
    var value_tohigh   = Blockly.Arduino.valueToCode(this, 'toHigh', Blockly.Arduino.ORDER_NONE);
