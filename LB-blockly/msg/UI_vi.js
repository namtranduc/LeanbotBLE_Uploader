...
var MSG = {
    ...
    catColour: "Colour",
    catVariables: "Biến",
    catFunctions: "Chức năng",
    listVariable: "list",
    textVariable: "text",
    screenshot: "Download Screenshot",
    xmlError: "Could not load your saved file. Perhaps it was created with a different version of Blockly Editor?",
    badXml: "Error parsing XML:\n%1\n\nSelect 'OK' to abandon your changes or 'Cancel' to further edit the file.",
    languageSpan: "Ngôn ngữ",
    ...
    loadDemoButton_span: "Mở chương trình mẫu",
    copyXMLButton_span: "Sao chép blocks",
    pasteXMLButton_span: "Dán blocks",
    ...
    newButton_span: "Tạo dự án mới",
    save_span: "Save file name?",
    saveXMLButton_span: "Lưu xuống tệp",
    loadXMLfakeButton_span: "Tải tệp lên",
    loadXML_span: "Replace existing blocks?\n'Cancel' will merge.",
    loadXML_error_span: "Error parsing XML:\n",
    resetButton_span: "Thiết lập lại",
    resetQuestion_span: "Thiết lập lại và",
    helpButton_span: "Trợ giúp",
    helpModalSpan_title: "Giới thiệu",
    helpModalSpan_text:
        '<table>' +
        '<tbody>' +
        '<tr>' +
        '<td style="width: 142px;"><img src="./blocklyduino/media/logo-lb-2.png" alt="" width="129" height="144" /></td>' +
        '<td>' +
        '<p style="text-align: left;"><strong>Blockly Editor</strong></p>' +
        '<p style="text-align: left;">Blockly Editor is a <strong>web program for editing and visual block programming for <a href="https://leanbot.space/">Leanbot</a> robot</strong>. It is based on <a href="https://developers.google.com/blockly/">Blockly</a>, the graphical online programming editor and on the work done on <a href="https://github.com/A-S-T-U-C-E/STudio4Education">STudio4Education</a>, a similar project for <a href="https://www.st.com/">STmicroelectronics</a> boards.</p>' +
        '<p style="text-align: left;">Blockly Editor provides a block programming environment and their translation into \'Arduino\' C code.</p>' +
        '</td>' +
        '</tr>' +
        '</tbody>' +
        '</table>' +
