...
var jsonToolboxCount = 0;
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][0];  // Logic
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][1];  // Loops
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][2];  // Math
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][3];  // Text
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][4];  // Lists
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][5];  // Colour
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][6];  // Variables
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_standard["contents"][7];  // Functions
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_arduino["contents"][0];
jsonToolbox["contents"][jsonToolboxCount++] = toolbox_leanbot["contents"][0];
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_leanbot_vi["contents"][0];
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_ds18b20["contents"][0];
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_grove["contents"][0];
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_relay["contents"][0];
// jsonToolbox["contents"][jsonToolboxCount++] = toolbox_servo["contents"][0];
...
Code.buildToolbox = function() {
	...
	if (toolboxIds === undefined || toolboxIds === "") {
		// always use all categories from js definition
		// if (boardSelected) {
		if (0) {
