 ...
 */
document.getElementById('copyCodeButton1').onmouseover = function () {
    document.getElementById("content_hoverButton").textContent = "Copy code to IDE";
};
document.getElementById('copyCodeButton1').onmouseout = function () {
...
document.getElementById('loadDemoButton').onmouseover = function () {
    document.getElementById("content_hoverButton").textContent = MSG['loadDemoButton_span'];
};
document.getElementById('loadDemoButton').onmouseout = function () {
    document.getElementById("content_hoverButton").textContent = "";
};
document.getElementById('copyXMLButton').onmouseover = function () {
    document.getElementById("content_hoverButton").textContent = MSG['copyXMLButton_span'];
};
document.getElementById('copyXMLButton').onmouseout = function () {
    document.getElementById("content_hoverButton").textContent = "";
};
document.getElementById('pasteXMLButton').onmouseover = function () {
    document.getElementById("content_hoverButton").textContent = MSG['pasteXMLButton_span'];
};
document.getElementById('pasteXMLButton').onmouseout = function () {
    document.getElementById("content_hoverButton").textContent = "";
};
